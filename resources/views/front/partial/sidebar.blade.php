  ...
  {{-- <div class="rounded-r bg-gray-900 xl:hidden flex justify-between w-full p-6 items-center ">
      ...
      {{-- <div class="flex justify-between  items-center space-x-3">
          ...
          <p class="text-2xl leading-6 text-white">معاونی</p>
      </div>
  ...
  {{-- </div> --}}
  {{-- the above component commited for unknown reseaon --}}

  <div id="Main"
      class="xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start    w-80 bg-gray-900 flex-col">
      <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->

      <div class="bg-gray-100 w-full h-14">
          <h1 class="text-center flex items-center  justify-center mt-3 text-2xl">K.P.U M.I.S</h1>
      </div>
      @if (Auth::user()->role == 'admin')
          <div
              ...
              <a href="#"
                  ...
                  &nbsp;&nbsp;
                  <p class="text-base leading-4 ">داشبورد</p>
              </a>
              <a href="{{ route('user.view') }}"
                  ...
                  &nbsp;&nbsp; <svg class="fill-stroke w-5 h-5" width="24" height="24" viewBox="0 0 24 24"
                  ...
                  &nbsp;&nbsp;
                  <p class="text-base leading-4 ">استفاده کننده</p>
              </a>
              ...
              <a href="{{ route('user.view') }}"
                  ...
                  &nbsp;&nbsp;
                  <p class="text-base leading-4 ">تنظیمات</p>
              </a>

          </div>
      @endif

      @if (Auth::user()->user_type == 'PDC_user')
          <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
              <button onclick="showMenu1(true)"
                  ...
                  <p class="text-sm leading-5  uppercase">آمریت P.D.C</p>

                  <svg id="icon1" class="transform w-5 h-5" width="24" height="24" viewBox="0 0 24 24"
                      fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div id="menu1" class="flex justify-start  flex-col w-full md:w-auto items-start pb-1 ">
                  <a href="{{ route('pdc.document') }}"
                      ...
                      <p class="text-base leading-4 ">مکتوب ها</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  ">پلان ها</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  ">کمیته ها</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  ">ورکشاپ ها</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  ">بورسیه ها</p>
                  </a>
                  {{-- <button
                  class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
      ...
      @if (Auth::user()->user_type == 'teacher_department_user')
          <div class="flex flex-col justify-start items-center  px-6 border-b border-gray-600 w-full  ">
              <button onclick="showMenu2(true)"
                  ...
                  <p class="text-sm leading-5 uppercase w-5 h-5">آمریت استادان</p>
                  <svg id="icon2" class="transform rotate-180 mr-20" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18 15L12 9L6 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                  </svg>
              </button>
              <div id="menu2" class=" flex justify-start flex-col items-start pb-5 ">
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      ...
                      <p class="text-base leading-4  ">استادان </p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  ">فاکولته ها </p>
                  </a>

              </div>
          </div>
      @endif
      @if (Auth::user()->user_type == 'department_of_gurantee_user')
          <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
              <button onclick="showMenu3(true)"
                  class="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                  <p class="text-sm leading-5  uppercase">آمریت تضمین کیفت</p>
                  <svg id="icon3" class="rotate-180 transform h-5 w-5" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18 15L12 9L6 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                  </svg>
              ...
              <div id="menu3" class="hidden flex justify-start flex-col items-start pb-5 ">
                  <a href="#"
                      ...
                      <p class="text-base leading-4  ">معیارات اصلی</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
      ...
      @if (Auth::user()->user_type == 'dpeartment_of_post_graduated_program_user')
          <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
              <button onclick="showMenu4(true)"
                  class="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                  <p class="text-sm leading-5  uppercase">آمریت فوق لیسانس</p>
                  <svg id="icon4" class="rotate-180 transform h-5 w-5" width="24" height="24"
                      viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18 15L12 9L6 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                  </svg>
              </button>
              <div id="menu4" class=" flex justify-start flex-col items-start pb-5 ">
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  ...
                  <a href="#"
                      ...
                      <p class="text-base leading-4  "> محصلین </p>
                  </a>
      ...
      @if (Auth::user()->user_type == 'dpeartment_of_science_research_user')
          <div class="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
              <button onclick="showMenu5(true)"
                  class="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  ">
                  <p class="text-sm leading-5  uppercase">آمریت تحقیقات علمی</p>
                  <svg id="icon5" class="rotate-180 transform h-5 w-5" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path d="M18 15L12 9L6 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round" />
                  </svg>
              </button>
              <div id="menu5" class="flex justify-start flex-col items-start pb-5 ">
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      ...
                      <p class="text-base leading-4  "> تحقیقات استادان</p>
                  </a>
                  <a href="#"
                      class="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                      <span class="mx-2">
                      ...
                      <p class="text-base leading-4  "> نشرات بین المللی </p>
                  </a>
